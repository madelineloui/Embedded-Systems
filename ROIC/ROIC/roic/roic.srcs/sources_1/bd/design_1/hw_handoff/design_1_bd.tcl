...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set duty_cycle_0 [ create_bd_port -dir I -from 3 -to 0 duty_cycle_0 ]
  ...
  set pwm_0 [ create_bd_cell -type ip -vlnv nasa.gov:user:pwm:1.0 pwm_0 ]
  ...
  connect_bd_net -net duty_cycle_i_0_1 [get_bd_ports duty_cycle_0] [get_bd_pins pwm_0/duty_cycle_i]
