...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwmcore_v1_0_S00_AXI is
  ...
  signal \duty_cycle[7]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \duty_cycle[31]_i_2\ : label is "soft_lutpair3";
begin
...
\duty_cycle[31]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\duty_cycle[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0200"
    )
        port map (
      ...
      I2 => p_0_in(0),
      I3 => s00_axi_wstrb(0),
      O => \duty_cycle[7]_i_1_n_0\
    );
\duty_cycle_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \duty_cycle[7]_i_1_n_0\,
      D => s00_axi_wdata(0),
      Q => duty_cycle(0),
      R => p_1_in
    );
...
u1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_core
     port map (
      Q(3 downto 0) => duty_cycle(3 downto 0),
      SR(0) => p_1_in,
      pwm_out => pwm_out,
